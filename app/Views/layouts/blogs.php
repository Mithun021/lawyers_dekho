                ...
                <div class="bloglist item">
                    <div class="post-content">
                        ...
                        <div class="post-image">
                            <img alt="" src="<?= base_url() ?>public/assets/images/news/1.jpg">
                        </div>
                        <div class="post-text">
            ...
            <div class="col-lg-4 col-md-6 mb30">
                <div class="bloglist item">
                    <div class="post-content">
                        ...
                        <div class="post-image">
                            <img alt="" src="<?= base_url() ?>public/assets/images/news/2.jpg">
                        </div>
                        <div class="post-text">
                            <span class="p-tagline">Law Firm</span>
            ...
            <div class="col-lg-4 col-md-6 mb30">
                <div class="bloglist item">
                    <div class="post-content">
                        ...
                        <div class="post-image">
                            <img alt="" src="<?= base_url() ?>public/assets/images/news/3.jpg">
                        </div>
                        <div class="post-text">
                            <span class="p-tagline">Law Firm</span>
